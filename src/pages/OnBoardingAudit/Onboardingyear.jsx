...
const Onboardingyear = () => {
  ...
  const fetchAdGroupData = () => {
    ...
    fetch("https://api.confidanto.com/get-campaign-yearly-metrics", {
      method: "POST",
      headers: {
      ...
      <div className="mx-10 bg-white">
        <div
          className={`rounded-lg border border-gray-300 shadow-sm p-4 ${
            isFullScreen
              ? "fixed inset-0 z-50 overflow-x-auto bg-white"
              : "mb-16"
          }`}
        >
          <div className="flex items-center">
            <span className="font-semibold text-lg">Past Year Data</span>
          </div>
