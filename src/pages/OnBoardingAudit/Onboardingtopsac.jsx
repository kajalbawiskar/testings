...
const Onboardingtopsac = () => {
  ...
  const fetchAdGroupData = () => {
    ...
    fetch("https://api.confidanto.com/top-selling-ad-copies", {
      method: "POST",
      headers: {
    ...
    <div className="mx-10 bg-white">
      ...
      >
        <div className="flex items-center">
          <span className="font-semibold text-lg">Top Sellign Ad Copies</span>
        </div>
...
export default Onboardingtopsac;
