...
const OnboardingLocation = () => {
  ...
  const fetchAdGroupData = () => {
    const requestBody = {
      ...
      end_date: "2024-10-10",
      // "single_date": "2025-01-29",
      // "date_range": "LAST_MONTH",
      location_type: "city",
    };

    fetch("https://api.confidanto.com/get-top-locations", {
      method: "POST",
      headers: {
      ...
      .then((responseData) => {
        ...
        setSortedData(responseData); // Initialize sorted data // Update table data
        setColumns([
          {
            id: "2",
            title: "location",
  ...
  const handleSort = (key) => {
    ...
    // setCurrentPage(4); // Reset to first page
  };
    ...
    <div className="mx-10 bg-white">
      ...
      >
        <div className="flex items-center">
          <span className="font-semibold text-lg">Top Locations</span>
        </div>
