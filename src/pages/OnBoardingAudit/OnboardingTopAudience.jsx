...
const OnboardingTopAudience = () => {
  ...
  const fetchAdGroupData = () => {
    ...
    fetch("https://api.confidanto.com/get-top-audience", {
      method: "POST",
      headers: {
    ...
    <div className="mx-10 bg-white">
      ...
      >
        <div className="flex items-center">
          <span className="font-semibold text-lg">Top Audience</span>
        </div>
...
export default OnboardingTopAudience;
