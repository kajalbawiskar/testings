...
const OnboardingBid = () => {
  ...
  const fetchAdGroupData = () => {
    ...
    fetch("https://api.confidanto.com/bid-strategy-used", {
      method: "POST",
      headers: {
    ...
    <div className="mx-10 bg-white">
      ...
      >
        <div className="flex items-center">
          <span className="font-semibold text-lg">Best bid Strategy Used</span>
        </div>
        ...
        {isOpen && (
          <main className="flex-grow text-lg -ml-8 -mt-5 overflow-y-scroll">
            ...
            <div className="flex justify-end items-center mt-4 font-roboto p-3 rounded-lg">
